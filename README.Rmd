...
states, the District of Columbia, and Puerto Rico, alongside tidy tibbles with
richer data. Territory data is provided in separate objects.
...
This package provides updated vectors covering all 52 entries (50 states + DC + PR).

```{r vectors, message=FALSE}
# 2 entries not in datasets::state.abb
